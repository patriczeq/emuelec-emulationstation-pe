...
bool ApiSystem::launchApp(Window *window, std::string command)
{
	...
	runSystemCommand("fbset -depth 0");
	runSystemCommand("fbset -depth 16");
	runSystemCommand("fbset -depth 32");
	runSystemCommand("fbset -depth 16");
...
std::vector<std::string> ApiSystem::getWifiNetworksPE()
{
	return executeEnumerationScript("bssidscan");
}

std::vector<std::string> ApiSystem::getScriptResults(const std::string cmd)
	{
